...
<form action="indexadmin.php?page=<?php echo base64_encode('WithdrawVIeW/treat_checque');?>" method="POST">
    
    <div class="btn btn-group-justified button button-3d  button-pill"> <strong> Cashcheque Withdrawal Transactions </strong> </div><br><br>
