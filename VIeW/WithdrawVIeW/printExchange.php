        ...
        &nbsp;&nbsp;&nbsp; _____________________________________________________________-->
             <div style="width: 100%; background-color: peachpuff; ">
                <div style="width: 67%; border: 2px; text-align: left; padding-top: -33m;">
                    <p> <strong> <span style=" margin-left: 2mm;"> Depositor's Name :</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $nn ?></span> </p>                     
                    ...
                    <p> <strong> <span style=" margin-left: 1mm;"> Amount Withdrawn :</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $amt." F CFA" ?></span> </p> 
