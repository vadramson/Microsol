        ...
        &nbsp;&nbsp;&nbsp; _____________________________________________________________-->
             <div style="width: 100%; background-color: peachpuff; ">
                <div style="width: 67%; border: 2px; text-align: left; padding-top: -33m;">
                    ...
                    <p> <strong> <span style=" margin-left: 1mm;"> Phone Number :</span> </strong> <span style="font-family: Arial; font-size: 10pt;;"> <?php echo $phn ?></span> </p> 
                    <p> <strong> <span style=" margin-left: 1mm;"> Foreign :</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $foreign." ".$cy  ?></span> </p> 
                    <p> <strong> <span style=" margin-left: 1mm;"> Local:</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $local." F CFA"?></span> </p>                  
