...
//    
    ...
    $nn =  $_SESSION["na"];
    $date =  $_SESSION["date"];
    $foreign = $_SESSION["asn"];
    $local = $_SESSION["asc"];
    $currency =  $_SESSION["asp"];
    $idcn = $_SESSION["nic"];
    $phn = $_SESSION["phone"];
    $em = $_SESSION["emp"];
    ...
    $bdd = new MicrosolDB();
    $current = $bdd->bdd->query("SELECT cscode FROM cy_seter WHERE csid = '".$currency."' ") or die(mysql_error());
    $reqt = $current->fetch();
    $cy = $reqt["cscode"];
...
?>
    ...
    <page backtop=".5mm" backbottom=".5mm" backleft=".5mm" backright="5mm" >
        ...
        <table style="width: 100%;border: none; background-color: #fbe9e7; ">
            <tr style="height: 5mm" >
                ...
                <td style="width: 35%; text-align: center; font-size: 7pt; font-weight: bold;">
                    ...
                    <h5>Reff N<sup>o</sup> <span style="text-decoration: underline;"> <?php echo $boy ?> </span></h5>
                </td><br> 
            </tr></table>
<!--        </table><br>
        ...
        &nbsp;&nbsp;&nbsp; _____________________________________________________________-->
             <div style="width: 100%; background-color: #fbe9e7; ">
                <div style="width: 67%; border: 2px; text-align: left; padding-top: -33m;">
                    <p> <strong> <span style=" margin-left: 2mm;"> Customer's Name :</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $nn ?></span> </p>                     
                    <p> <strong> <span style=" margin-left: 1mm;"> Amount :</span> </strong> <span style="font-family: Arial; font-size: 10pt;;"> <?php echo $currency." F CFA" ?></span> </p> 
                    <p> <strong> <span style=" margin-left: 1mm;"> Asset's Name :</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $foreign ?></span> </p> 
                    <p> <strong> <span style=" margin-left: 1mm;"> Asset's Code:</span> </strong> <span style="font-family: Arial; font-size: 10pt;"> <?php echo $local?></span> </p>                  
...
<br><br>&nbsp;&nbsp;&nbsp; _____________________________________________________________<br><br>
        ...
        <table style="width: 100%;border: none; overflow: hidden;">
            <tr style="height: 5mm" >
             ...
             <div style="margin-left: 90mm; margin-bottom: -65mm; text-align: center; float: right; height: 40mm; background-color: #fbe9e7;">
                           <br>  <img src="../VIeW/images/logo.png" alt="logo" ><br><br>
                           <strong> Broker </strong> <br>  <?php echo $fn.' '. $ln;?><br><br>
                           <strong> Branch </strong> <br> <?php echo $bn;?>
                </div>
