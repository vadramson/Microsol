...
//        print_r($image_extension); test if it works.
    ...
    move_uploaded_file($picture_temp,'images/employee_picture/'.$picture);
...
<form action="#" method="POST" enctype="multipart/form-data" >
    ...
    <div class="button button-pill button-primary"> <strong> Enter Employee's Personal Information Below </strong> </div><br><br>
