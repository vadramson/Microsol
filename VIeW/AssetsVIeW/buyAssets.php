...
<form action="#" method="POST">
    ...
    <div class="button button-pill button-primary"> <strong> Buy Assets </strong> </div><br><br>
    <table id="tab_new_etud">   
    <tr>
    <td><b>Asset Name</b></td>&nbsp;&nbsp;&nbsp;
        <td> <input type="text" value="" class="form-control" name="asn" placeholder="Assets Name " size="110" required ><br> </td>
    </tr>
    <tr>
