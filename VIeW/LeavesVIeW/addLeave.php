...
//    print_r($agp);
    ...
    /* Generate Person code  */
     ...
     $leave = "LEV";
     $travelcode = $leave . $random_number . $random_string; // concatenate the generated codes 
...
<form action="#" method="POST">
    ...
    <div class="button button-pill button-primary"> <strong> Fill The Leave Request Form</strong> </div><br><br>
    ...
    <td><b>Type of Leave</b></td>&nbsp;&nbsp;&nbsp;
        <td> <input type="text" value="" class="form-control" name="reason" placeholder="Type of Leave" size="110" required ><br> </td>
    </tr>
    <tr>
